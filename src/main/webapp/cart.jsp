...
<%@include file="include/header.jsp"%>
    ...
    <section id="cart" style="margin:0; padding:20px; ">
        <div style="height: 100px;"></div><!--佔位-->
        <div class="row" id="main_container" style="margin: 10px 20px 50px 20px;  ">

            <div class="container">
                <div class="card-header my-3"><h1>實體商品購物車</h1></div>
                    ...
                    if(cart_list !=null){
                    	for(Cart c:cartProduct){
                    		%>
                             ...
                             <td><img alt="cart-img" src="products_img/<%=c.getFilename()%>"></td>
                             <td><h4><%=c.getCategory() %></h4></td>                           
                             <td>
                                 <form action="order-now" method="post" class="form-inline">
                                     <input type="hidden" name="id" value="<%=c.getPid()%>" class="for-input">
                             ...
                             <!-- 移除 -->
                             <td><a class="btn btn-sm btn-secondary" href="remove-from-cart?id=<%=c.getPid()%>"><i class="fas fa-trash-alt"></i></a></td>
                         </tr>
                   <%	}
                    }
                    %> 
